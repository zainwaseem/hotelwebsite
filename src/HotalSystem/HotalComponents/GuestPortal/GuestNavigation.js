...
function GuestNavigation() {
    ...
    return (<section class="w-full px-8 text-gray-700 bg-white">
        <div class="container flex flex-col flex-wrap items-center justify-between py-5 mx-auto md:flex-row max-w-7xl">
            <div class="relative flex flex-col md:flex-row">
                ...
                <nav class="flex flex-wrap items-center mb-5 text-base md:mb-0 md:pl-8 md:ml-8 md:border-l md:border-gray-200">
                    <Link class="mr-5 font-medium leading-6 text-gray-600 hover:text-gray-900">Rooms</Link>
                    <Link class="mr-5 font-medium leading-6 text-gray-600 hover:text-gray-900">Bookes-Room</Link>
                    <Link class="mr-5 font-medium leading-6 text-gray-600 hover:text-gray-900">History</Link>
                </nav>
            </div>
