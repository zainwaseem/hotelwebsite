            ...
            <div class="container flex flex-col flex-wrap items-center justify-between py-5 mx-auto md:flex-row max-w-7xl">
                <div class="relative flex flex-col md:flex-row">
                    ...
                    <nav class="flex flex-wrap items-center mb-5 text-base md:mb-0 md:pl-8 md:ml-8 md:border-l md:border-gray-200">
                        <Link to='/Staff' class="mr-5 font-medium leading-6 text-gray-600 hover:text-gray-900">Add-Room</Link>
                        <Link to='/Staff/AvalibleRoom' class="mr-5 font-medium leading-6 text-gray-600 hover:text-gray-900">Avalible Room</Link>
                        <Link to='/Staff/BookedRoom' class="mr-5 font-medium leading-6 text-gray-600 hover:text-gray-900">Booked Room</Link>
                        <Link class="mr-5 font-medium leading-6 text-gray-600 hover:text-gray-900">Duty</Link>
                    </nav>
                </div>
